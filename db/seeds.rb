...
first_user = User.create!(name: 'Hola', photo: 'https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2787&q=80', bio: 'Lorry driver in UK.')
...
Comment.create(post_id: first_post.id, user_id: second_user.id, text: 'Hi Oli!' )
