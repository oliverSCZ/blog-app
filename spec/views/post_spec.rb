...
RSpec.describe 'Post', type: :feature do
  before :all do
    ...
    if @post1.comments.empty?
      @comment1 = @post1.comments.create(text: 'Comment text 1', author_id: @first_user.id)
      @comment2 = @post1.comments.create(text: 'Comment text 2', author_id: @first_user.id)
    else
